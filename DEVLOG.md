...
| **4 силы** · v · α_s · runner · girth · GR паспорт · **Weinberg $3/13$** | §8.4.1–§8.4.3 | sim census / IR / Einstein / CKM / θ_W run | seed+runner+girth+GR+θ_W ✅ | census · IR · $G_{μν}$ · CKM · θ_W@$M_Z$ |
...
- **§8.4.1–§8.4.3:** α_s runner $v\to M_Z$ ✅ · FCC girth ✅ · **GR паспорт** ✅ · **Weinberg** $\sin^2\theta_W=3/13$ (FCC $12{+}1$, $N_\varphi$ совпадает) ✅ · **sim census** — open · IR · Einstein · CKM · бегунок $\theta_W$@$M_Z$
