...
**α·U0·soft-face:** preferred α=7 M² κ (7M+κ)/(49 M⁴−7 M κ³−8) ~−0.000068 ppm vs CODATA 2022 (~0.45σ, inside band); seat+face unit. `Alpha_U0_soft_face_ask`. Soft lab door closed; **unit-descent** (−8/7 why) still OPEN; `n_sq` wired from cubocta geo.
