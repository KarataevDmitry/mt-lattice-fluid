\begin{tikzpicture}[carrier panel, x=0.72cm, y=0.64cm]
  ...
  \begin{scope}[shift={(5.2,0)}]
    \node[draw, carrier object, carrier fill, minimum size=0.9cm] at (0,1.5) {$g$};
    \draw[carrier arrow] (-0.9,1.5) -- (-0.45,1.5);
    \draw[carrier arrow] (0.45,1.5) -- (0.9,1.5);
    \node[carrier muted, font=\scriptsize] at (0,0.85) {параллельно};
  \end{scope}
