...
Дискретные уровни, запрет Паули и конечный каталог состояний на одном планконе
(этаж~0) разобраны в \cref{ch:floor0-spectrum}.
Здесь же остаётся связка с макроуровнем: атомные орбитали на~$T$ --- readout
составного узла; планкон несёт ту же логику квантования на~$\Mlayer$.
