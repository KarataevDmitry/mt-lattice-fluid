...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[t]{0.92\linewidth}
    \centering
    \input{figures/tikz/carrier-field-z.tex}
...
\begin{figure}[htbp]
  \centering
  \input{figures/tikz/carrier-epsilon.tex}
...
\begin{figure}[htbp]
  \centering
  \input{figures/tikz/carrier-hex-neighbors.tex}
...
\begin{figure}[htbp]
  \centering
  \input{figures/tikz/carrier-two-speeds.tex}
...
\begin{figure}[htbp]
  \centering
  \input{figures/tikz/carrier-worldlines.tex}
...
\begin{figure}[htbp]
  \centering
  \input{figures/tikz/carrier-slice-bridge.tex}
