...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[t]{0.72\linewidth}
    \centering
    \input{figures/tikz/carrier-lattice-field.tex}
  ...
  \begin{subfigure}[t]{0.88\linewidth}
    \centering
    \input{figures/tikz/carrier-sync-step.tex}
...
\begin{figure}[htbp]
  \centering
  \input{figures/tikz/carrier-tilings.tex}
...
\begin{figure}[htbp]
  \centering
  \input{figures/tikz/carrier-neighbors-2d.tex}
...
\begin{figure}[htbp]
  \centering
  \input{figures/tikz/carrier-hex-radii.tex}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[t]{0.32\linewidth}
    \centering
    \input{figures/tikz/carrier-packing-sc.tex}
    \caption{SC, $|N|=6$.}
    \label{fig:carrier-packing-sc}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.32\linewidth}
    \centering
    \input{figures/tikz/carrier-packing-bcc.tex}
    \caption{BCC, $|N|=8$.}
    \label{fig:carrier-packing-bcc}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.32\linewidth}
    \centering
    \input{figures/tikz/carrier-packing-fcc.tex}
    \caption{FCC, $|N|=12$.}
...
\begin{figure}[htbp]
  \centering
  \input{figures/tikz/carrier-cubocta-faces.tex}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[t]{0.72\linewidth}
    \centering
    \input{figures/tikz/carrier-hull-voronoi.tex}
    \caption{Три радиуса на одном узле.}
    \label{fig:carrier-hull-voronoi}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.50\linewidth}
    \centering
    \input{figures/tikz/carrier-voronoi-cell.tex}
...
\begin{figure}[htbp]
  \centering
  \input{figures/tikz/carrier-fcc-111-slice.tex}
