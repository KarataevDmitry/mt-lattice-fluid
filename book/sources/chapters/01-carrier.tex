...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[t]{0.92\linewidth}
    ...
    \caption{Состояние узла $z(x)\in\mathbb{C}^2$ и локальный закон $g$ на $N(x)$.}
    \label{fig:carrier-field-z}
  \end{subfigure}\\[0.5em]
  \begin{subfigure}[t]{0.88\linewidth}
    \centering
    \includegraphics[width=\linewidth]{carrier-sync-step.pdf}
    \caption{Синхронный такт: $\Psi^t\to\Psi^{t+1}$.}
    \label{fig:carrier-sync-step}
  \end{subfigure}
  \caption{Решётка, поле на узле и локальная эволюция.}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.92\linewidth]{carrier-neighbors-2d.pdf}
  \caption{Соседство $N(x)$ на трёх регулярных решётках: $|N|=3$, $4$ и $6$.}
  \label{fig:carrier-neighbors-2d}
\end{figure}

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.62\linewidth]{carrier-hex-neighbors.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.58\linewidth]{carrier-hex-radii.pdf}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[t]{0.32\linewidth}
    \centering
    \includegraphics[width=\linewidth]{carrier-packing-sc.pdf}
    \caption{SC, $|N|=6$.}
    \label{fig:carrier-packing-sc}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.32\linewidth}
    \centering
    \includegraphics[width=\linewidth]{carrier-packing-bcc.pdf}
    \caption{BCC, $|N|=8$.}
    \label{fig:carrier-packing-bcc}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.32\linewidth}
    \centering
    \includegraphics[width=\linewidth]{carrier-packing-fcc.pdf}
    \caption{FCC, $|N|=12$.}
    \label{fig:carrier-packing-fcc}
  \end{subfigure}
  \caption{Три кубические упаковки равных сфер (первая координационная оболочка).}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[t]{\linewidth}
    ...
    \caption{Световой конус $c_0$: первая оболочка на конусе, вторая ($h_L\sqrt{2}$) --- вне.}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.92\linewidth]{carrier-cubocta-faces.pdf}
...
массивная частица --- зигзаг внутри того же конуса (\cref{fig:carrier-worldlines}).
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\linewidth]{carrier-worldlines.pdf}
  \caption{Мировые линии в $(x,t)$: верхний ряд --- FCC ($\kgeom=1/\sqrt{2}$), нижний --- гекс-срез $(2{+}1)$ ($\kgeom_{\mathrm{hex}}=\sqrt{3}/2$); микро-null, массивный зигзаг и макро-фотон $c=\kgeom c_0$.}
  \label{fig:carrier-worldlines}
\end{figure}
