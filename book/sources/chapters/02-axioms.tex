...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.92\linewidth]{axiom-locality.pdf}
  \caption{Условия $A_1$--$A_2$: световая окрестность $N(x)$ и локальный закон $g$.}
  \label{fig:axiom-locality}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.92\linewidth]{axiom-unitarity.pdf}
  \caption{Условия $A_3$--$A_4$: сохранение нормы и спинор $z\in\mathbb{C}^2$.}
  \label{fig:axiom-unitarity}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.92\linewidth]{axiom-thermo.pdf}
  \caption{Условия $A_5$--$A_6$: недостижимый ноль амплитуды и рост фазовой энтропии при фиксированном $N$.}
  \label{fig:axiom-thermo}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\linewidth]{axiom-defects.pdf}
  \caption{Условия $A_9$--$A_{11}$: голономия $\zeta$, квантование намотки и anti-smear вихря.}
  \label{fig:axiom-defects}
\end{figure}
...
она возникает из динамического хаоса фаз и грубости прибора (\cref{fig:axiom-m-t}).

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.88\linewidth]{axiom-m-t.pdf}
  \caption{Детерминированное микрополе $z$ и грубый макро-readout $\Phi=\mathcal{B}z$.}
  \label{fig:axiom-m-t}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.72\linewidth]{axiom-heat-death.pdf}
