...
\begin{figure}[htbp]
  \centering
  \input{figures/tikz/axiom-a1-neighborhood.tex}
  \caption{$A_1$: световая окрестность $N(x)$, $c_0\htick=\hl$.}
  \label{fig:axiom-a1-neighborhood}
\end{figure}

\begin{figure}[htbp]
  \centering
  \input{figures/tikz/axiom-a2-local-law.tex}
...
\begin{figure}[htbp]
  \centering
  \input{figures/tikz/axiom-a3-phase.tex}
...
\begin{figure}[htbp]
  \centering
  \input{figures/tikz/axiom-a4-su2.tex}
...
\begin{figure}[htbp]
  \centering
  \input{figures/tikz/axiom-a5-vacuum.tex}
...
\begin{figure}[htbp]
  \centering
  \input{figures/tikz/axiom-a6-entropy.tex}
...
\begin{figure}[htbp]
  \centering
  \input{figures/tikz/axiom-a9-holonomy.tex}
...
\begin{figure}[htbp]
  \centering
  \input{figures/tikz/axiom-a10-winding.tex}
...
\begin{figure}[htbp]
  \centering
  \input{figures/tikz/axiom-a11-vortex.tex}
...
\begin{figure}[htbp]
  \centering
  \input{figures/tikz/axiom-layer-m.tex}
...
\begin{figure}[htbp]
  \centering
  \input{figures/tikz/axiom-layer-t.tex}
