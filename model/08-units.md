# §8.2·α·meter · финт: N_a0/a0 — макроописание, не вход
...
= \frac{a}{2}.
$$
**`κ=1/√2`** — макро-усреднение по **□-грани hull**; **стена Voronoy** ближе: **`a/2`**. Осевая вершина WS лежит на расстоянии **`κa`** — там же, где **inradius hull**.
